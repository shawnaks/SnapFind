...
<img src="https://github.com/shawnaks/lost-and-found/blob/main/client/LostFound/public/android192_3.png" width="30%" style="position: relative; top: 0; right: 0;" alt="Project Logo"/>
...
2. **Clone Locally**: Clone the forked repository to your local machine using a git client.
   ```sh
   git clone C:\Users\caomi\GitHub\lost-and-found
   ```
...
<br>
<p align="left">
   <a href="https://LOCAL{/GitHub/lost-and-found/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=GitHub/lost-and-found">
   </a>
</p>
</details>
